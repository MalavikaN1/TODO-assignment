...
var todo = ["apple", "orange", "banana"];                     //initial data
if (!localStorage.getItem("todo"))
  localStorage.setItem("todo", JSON.stringify(todo));         //setting data in localstorage
  ...
  const editItem = (index) => {
    ...
    const editItemClicked = (index,item) => {                                              //edit an item
    setShowIndex(-1);
  ...
  return (
    <div className="list">
      <Button onClick={redirectHome} variant="outlined" sx={{left:"40vh",marginBottom:"2%"}}>Logout</Button>
      <div
        className="container"
        style={{ width: "752px", marginLeft: "25%", border: "2px solid black", backgroundColor: "aliceBlue",textAlign:"center"}}
      >
       <div style={{textAlign:"center",display:"block"}}><h1>TODO</h1></div>
                  ...
                  <ListItem
                    secondaryAction={
                      <>
                        ...
                        <IconButton disabled={deleteFlag}
